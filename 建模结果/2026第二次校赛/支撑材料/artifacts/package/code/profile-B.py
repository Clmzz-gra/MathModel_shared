...
ax.plot(range(1, 31), var_ratio[:30], "o-", color="#1f77b4", label="方差解释率")
ax.axhline(1.0, color="red", linestyle="--", linewidth=1, label="Kaiser 准则线 (λ=1)")
ax.set_xlabel("主成分序号")
ax.set_ylabel("方差解释率")
ax.set_title("PCA 碎石图（前 30 主成分）")
ax.legend()
ax.grid(alpha=0.3)
fig.tight_layout()
