...
# Youden 阈值竖虚线（加入图例，避免 τ* 符号费解）
ax.axvline(tau, color=C_RED, lw=1.6, ls="--", zorder=2, label=f"训练 Youden 阈值 {tau:.4f}")
...
fig.suptitle("C3 阈值偏移：测试概率分布左移导致阈值失准", y=0.97, fontsize=11)
