...
2. 在问题 1的假设下，计算海面风速为 36m/s 时钢桶和各节钢管的倾斜角度、锚链形状和浮标的游动区域。并调节重物球的质量，使得钢桶的倾斜角度不超过 5 度，锚链在锚点与海床的夹角不超过 16 度。
...
![](images/4bc569cd217ab4915e03842cc12aa21ffec41cc1c29480d12af43130a974687d.jpg)  
图 1 浮标系统受力图

根据平面汇交力系的相关知识<sup>【1】</sup>，将各力作用点等效在浮标系统的重心上，以浮标系统重心为原点，如下图建立平面直角坐标系：

![](images/f4d394ed941e6033ab36cf6df5e98de2172f9b4d146d46a93ae5ffcb8d62f7d6.jpg)  
0、 $o ^ { \prime }$ 分别是重力、浮力的作用点  
图 2 受力及受力点示意图

![](images/2b76ec4fee5cdf965955ae7d97bf7272714334be04e3c7b55d9f270247bdf95d.jpg)  
图 3 受力示意图

在 x 轴和y轴方向上分别列出静力学平衡方程：

$$
\begin{array}{r l} & {{ \sum F _ {x} = 0 \text {:} \quad F _ {\mathrm{风}} - F _ {1} \sin \theta_ {1} = 0}} \\ & {{ \sum F _ {y} = 0 \text {:} \quad F _ {\mathrm{浮}} - G - F _ {1} \cos \theta_ {1} = 0}} \end{array}
$$

又：

$$
\begin{array}{r} {{F _ {\mathrm{风}} = 0. 6 2 5 v ^ {2} \times R _ {f} h}} \\ {{F _ {\mathrm{浮}} = \rho g \pi (h _ {f} - h)}} \end{array}
$$

得出

$$
\begin{array}{r l} & {{0. 6 2 5 v ^ {2} \times \mathrm{R} _ {f} h = F _ {1} \sin \theta_ {1}}} \\ & {{\rho g \pi \big (R _ {f} - h \big) = G _ {\mathrm{标}} + F _ {1} \cos \theta_ {1}}} \end{array}\tag{1}
$$
...
![](images/660cc9b116bf1076e21c1144ecfe7a5c22c9f34b0992c90fb476cc7c856ef43b.jpg)  
图 4 动稳性曲线
...
![](images/d8a20c640a1bd3685f67640f194b984e3c983b0f0e7bbd67059156effe552bd0.jpg)  
图 5 单节钢管受力图
...
$$
\sum F _ {y} = 0 \colon F _ {i + 1} \cos \theta_ {i + 1} - F _ {i} \cos \theta_ {i} - F _ {\text {浮} i} - G _ {i} = 0\tag{7}
$$
...
$$
\begin{array}{r} {{F _ {\mathrm{浮}} = \rho_ {\mathrm{海水}} g V}} \\ {{G = m g}} \\ {{m = \rho \cdot V}} \\ {{V = \frac {4}{3} \pi R ^ {2}}} \end{array}
$$

联立上式，解得：

$$
F _ {\mathrm{浮}} = \frac {\rho_ {\mathrm{海水}}}{\rho} \cdot G
$$
...
倍数关系较大。结合实际生产生活情况，重物球的材质应为 10CrMoA $( \rho = 7 . 6 5 g \cdot c m ^ { - 3 } )$ ）。此时，

$$
\begin{array}{r l} & {\mathrm{R} = \sqrt [ 3 ]{\frac {m}{\rho \pi} \cdot \frac {3}{4}} \approx 0. 3 3 5 m \approx 2. 2 3 3 R _ {g}} \\ & {\qquad F _ {\text {浮} 2} = \frac {1 . 0 2 5}{7 . 6 5} \cdot G \approx 0. 1 3 4 G} \end{array}
$$

符合要求，且 $F _ { \vec { \mathcal { F } } 1 } < F _ { \vec { \mathcal { F } } 2 }$ 。因此，重物球所受浮力不可忽略。

根据题意，钢桶的小角度偏转度数 $\alpha _ { \ddag \overrightarrow { \mathbb { H } } }$ 在 $5 ^ { \circ }$ 以内，受力分析图中不易体现，但在方程分析中不能忽略。因此，钢桶和重物球组成的整体的静力平衡状态如下图所示：

![](images/1c997a6b4dd5a60cbb26a773b929b063946907f7e97028f0c0781fa62c9143cb.jpg)  
图 6 钢桶、重物球系统受力图

在 x 轴、y 轴两个方向分别列出静力学平衡方程：

$$
\sum F _ {x} = 0 \colon F _ {5} \sin \theta_ {5} - F _ {\mathrm{锚}} \sin \theta_ {\mathrm{锚}} = 0\tag{19}
$$
...
$$
F _ {5} \times \frac {1}{2} \times \sin (\alpha_ {\mathrm{桶}} - \theta_ {4}) - F _ {\mathrm{锚}} \times \frac {1}{2} \times \sin \left(\theta_ {\mathrm{锚}} - \alpha_ {\mathrm{桶}}\right) = 0\tag{21}
$$
...
取一小段锚链（ds），则可以将锚链悬垂长度的垂向投影分量的微元（dy）用 ds 表示，从锚链底端至上端积分可以得到 y 与s 的表达式。

![](images/49f347677b3818cc9d799b23c981c81b019ed24b3c9cd1da026a4faa1ca650e4.jpg)  
图 7 锚链受力图

![](images/fc10868327f5709e9fcdd8fbbccec79f4735ec54f02658ecb1fd0e16e22e14a4.jpg)  
图 8 锚链微元分析图
...
$$
\begin{array}{r l} & {F _ {\text {水平}} = F _ {\text {锚}} \sin \theta_ {\text {锚}} = F _ {0} \sin \theta_ {0}} \\ & {F _ {\text {竖直}} = F _ {\text {锚}} \cos \theta_ {\text {锚}} = m g s - \rho g A s + F _ {0} \cos \theta_ {0}} \end{array}\tag{23}
$$
...
$$
\begin{array}{r} a = m g - \rho g A \\ b = F _ {0} \cos \theta_ {0} \\ c = F _ {0} \sin \theta_ {0} \end{array}
$$

$$
\begin{array}{l} y = \frac {c}{a} \cdot \frac {1}{\cos t} \Bigg | _ {\arctan \frac {b}{c}} ^ {\arctan \frac {a s + b}{c}} \\ = \frac {c}{a} \cdot \left(\frac {1}{\cos (\arctan \frac {a s + b}{c})} - \frac {1}{\cos (\arctan \frac {b}{c})}\right) \end{array}\tag{25}
$$
...
![](images/0ec3a1e486e8c0f61a81aee7128bbea709ffd4b594724383aeac6fd964d5da27.jpg)  
图 9 锚链部分拖地示意图

5.1.2.5 各组成部分的关联性分析：

![](images/b843c60844fa47971f72b7a6f978afb2275429083109a57680fa8d8a46a507d3.jpg)  
图 10 系统结构示意图
...
初步判断临界风速realv取值在 $1 0 { - } 3 0 \mathrm { m } \cdot s ^ { - 1 }$ 范围内。由于 $\cdot \theta _ { 0 }$ 和s均为已知量，联立上述（1）\~（26）号方程并缩小待求两范围，得到 $\mathrm { \ r e a l v } = 2 1 . 9 2 0 0 \mathrm { m } \cdot s ^ { - 1 }$ 。以系泊系统各部件垂向投影长度 y等于海水深度为目标，以浮标系统出水高度 h 为自变量，控制自变量在 0\~2 之间。调节自变量，用 MATLAB软件，使用循环遍历方法找到系泊系统各部件垂向投影长度最接近海水深度 18m的解，分别讨论风速为 12m/s（锚链拖地）、24m/s（锚链不拖地）的情况。详细结果如下表所示：

<table><tr><td colspan="2">风速</td><td>12m/s</td><td>24m/s</td></tr><tr><td colspan="2">钢桶倾斜角 $\alpha_{\text{桶}}$ </td><td>1.209°</td><td>4.584°</td></tr><tr><td rowspan="3">各节钢管倾斜</td><td> $\alpha_1$ </td><td>1.163°</td><td>4.429°</td></tr><tr><td> $\alpha_2$ </td><td>1.175°</td><td>4.458°</td></tr><tr><td> $\alpha_3$ </td><td>1.180°</td><td>4.486°</td></tr><tr><td>角 $\alpha_i (i=1,2,3,4)$ </td><td> $\alpha_4$ </td><td>1.186°</td><td>4.521°</td></tr><tr><td colspan="2">锚链形状</td><td>16.253m长的部分平躺在海床上;剩余部分的参数方程表达式: $y = 3.9763(\sqrt{0.2515s^2 + 1} - 1)$  $x = 3.9763\ln(\sqrt{(0.2515s)^2 + 1} + 0.2515s)$ </td><td>1初始状态,锚链与海床夹角4.561°;2参数方程表达式: $y = 15.7338\left(\sqrt{(0.0636s + 0.0798)^2 + 1} - 1.0032\right)$  $x = 15.7338\left[\ln\left(\sqrt{(0.0636s + 0.0798)^2 + 1} + 0.0636s + 0.0798\right) - 0.4703\right]$ </td></tr><tr><td colspan="2">吃水深度h</td><td>0.6816m</td><td>0.6958m</td></tr><tr><td colspan="2">游动区域半价R</td><td>14.6591m</td><td>17.7716m</td></tr></table>

表 1 ���/�、 ��/�风速下系统部分结构状态

![](images/42db57d88d9d1d87375bfe26e9cf0cb16460e8eab0af716eec19d520af9dc860.jpg)  
图 11 风速 12�/�时锚链形状示意图

![](images/8f1e93d5a84f10c3ab962b5c9deaa8581e7f37f41fbc257763524e0effbc4ed2.jpg)  
图 12 风速 24�/�时锚链形状示意图
...
![](images/5efd3323f200dc801f99fff460fc1e63bf35d9663213a27b605c873f7539f0b3.jpg)  
图 13 模型检验图
...
<table><tr><td colspan="2">风速</td><td>36m/s</td></tr><tr><td colspan="2">钢桶倾斜角 $\alpha_{\text{桶}}$ </td><td>9.482°</td></tr><tr><td rowspan="4">各节钢管倾斜角 $\alpha_i (i=1,2,3,4)$ </td><td> $\alpha_1$ </td><td>9.190°</td></tr><tr><td> $\alpha_2$ </td><td>9.242°</td></tr><tr><td> $\alpha_3$ </td><td>9.299°</td></tr><tr><td> $\alpha_4$ </td><td>9.356°</td></tr><tr><td>锚链形状</td><td>1锚链在锚点与海床的夹角为20.867°;2剩余部分的参数方程表达式: $y = 34.7849(\sqrt{(0.0287s + 0.3811)^{2} + 1} - 1.0702)$  $x = 34.7849(\ln(\sqrt{(0.0287s + 0.3811)^{2} + 1} + 0.0287s + 0.3811) - 0.6303))$ </td></tr><tr><td>吃水深度h</td><td>0.7185m</td></tr><tr><td>游动区域半价R</td><td>18.8799m</td></tr></table>

表 2 �� /�风速下系统部分结构状态

![](images/f322c047b4e536956a234c3564a0166551c29502bd30c61f19bbbf428ecb1310.jpg)  
图 14 风速 36�/�时锚链形状示意图
...
浮标能够正常采集数据需要吃水深度尽量小且浮标不能沉没，游动区域则反映了浮标的稳定程度，钢桶倾斜角小于 $5 ^ { \circ . }$ 也是系泊系统正常工作的条件。接下来，采用层次分析法<sup>【3】</sup>，根据前两问的计算及题目要求，我们确定了钢桶的倾斜角度、浮标吃水深度、游动区域三个指标的判别矩阵A。

$$
A = \left\{ \begin{array}{c c c} 1 & \frac {1}{5} & \frac {1}{3} \\ 5 & 1 & 3 \\ 3 & \frac {1}{3} & 1 \end{array} \right\}
$$
...
$$
\begin{array}{r} {{F _ {\mathrm{风}} = 0. 6 2 5 v ^ {2} \times R _ {f} h}} \\ {{F _ {\mathrm{浮}} = \rho g \pi (h _ {f} - h)}} \\ {{F _ {\mathrm{水}} = 3 7 4 v ^ {2} \times R _ {f} \times (2 - h)}} \end{array}
$$

得出

$$
\begin{array}{l} {0. 6 2 5 v ^ {2} \times \mathrm{R} _ {f} h + 3 7 4 v ^ {2} \times R _ {f} \times (2 - h) = F _ {1} \sin \theta_ {1}} \\ {\rho g \pi \big (R _ {f} - h \big) = G _ {\text {标}} + F _ {1} \cos \theta_ {1}} \end{array}\tag{1}
$$
...
$$
\sum F _ {y} = 0: F _ {i + 1} \cos \theta_ {i + 1} - F _ {i} \cos \theta_ {i} - F _ {\text {浮} i} - G _ {i} = 0\tag{7)~(10}
$$

$$
F _ {\mathrm{水} i} = 3 7 4 \times H _ {i} \times 0. 0 5 v ^ {2}
$$
...
$$
\sum F _ {x} = 0 \colon F _ {5} \sin \theta_ {5} - F _ {\mathrm{锚}} \sin \theta_ {\mathrm{锚}} - F _ {\mathrm{水桶}} = 0\tag{19}
$$
...
$$
\begin{array}{c} {a = m g - \rho g A} \\ {b = F _ {0} \cos \theta_ {0}} \\ {c = F _ {0} \sin \theta_ {0} - 3 7 4 \times 0. 0 2 (H - \sum H _ {i} - (2 - h)) v ^ {2}} \end{array}
$$

$$
\begin{array}{l} y = \frac {c}{a} \cdot \frac {1}{\cos t} \Bigg | _ {\arctan \frac {b}{c}} ^ {\arctan \frac {a s + b}{c}} \\ = \frac {c}{a} \cdot (\frac {1}{\cos (\arctan \frac {a s + b}{c})} - \frac {1}{\cos (\arctan \frac {b}{c})}) \end{array}\tag{25}
$$
...
$$
\begin{array}{c} {y = 4. 7 3 7 6 (\sqrt {0 . 0 4 4 6 \mathrm{s} ^ {2} + 1} - 1)} \\ {x = 4. 7 3 7 6 \times (\ln \sqrt {0 . 0 4 4 6 \mathrm{s} ^ {2} + 1} + 0. 2 1 1 1 \mathrm{s})} \end{array}
$$
...
$$
\begin{array}{c} {y = 6. 9 7 4 7 (\sqrt {0 . 0 2 0 6 s ^ {2} + 1} - 1)} \\ {x = 4. 7 3 7 6 \times \ln (\sqrt {0 . 0 2 0 6 s ^ {2} + 1} + 0. 1 4 3 4 s)} \end{array}
$$
...
![](images/5942b1e567c38b08b9ce47ac101b67c1669666e9978a31b225acef3cbead5d09.jpg)  
图 15 第 2 种情况锚链形状示意图
...
<table><tr><td>h(m)</td><td>1.3180</td><td>1.3181</td><td>1.3182</td><td>1.3183</td><td>1.3184</td><td>1.3185</td><td>1.3186</td><td>1.3187</td><td>1.3188</td></tr><tr><td>2- h(m)</td><td>0.6820</td><td>0.6819</td><td>0.6818</td><td>0.6817</td><td>0.6816</td><td>0.6815</td><td>0.6814</td><td>0.6813</td><td>0.6812</td></tr><tr><td>H&#x27;(m)</td><td>18.2005</td><td>18.1489</td><td>18.0972</td><td>18.0456</td><td>17.9940</td><td>17.9424</td><td>17.8908</td><td>17.8392</td><td>17.7877</td></tr><tr><td>ΔH(m)</td><td>0.2005</td><td>0.1489</td><td>0.0972</td><td>0.0456</td><td>0.0060</td><td>0.0576</td><td>0.1092</td><td>0.1608</td><td>0.2123</td></tr></table>
...
```matlab
附件3问题一、二风速24m/s和36m/s时各参数算法matlab代码（36m/s时只需将第二行的v改为36）
p=1025;
v=24;
g=9.8;
Mbuoy=1000;
...
```matlab
% s=(Fchain*cos(theta0)-F0*cos(theta0))/(0.87*m*g);
a=0.87*m*g;
b=F0*cos(theta0);
c=F0*sin(theta0);
y=(c/a)*(1/cos(atan((a*s+b)/c))-1/cos(atan(b/c)));
...
Gdrum=Mdrum*g;
judge=100;
%数据的初始化，缺少量为水深H，锚链单位质量m,锚链长度s,重物球质量Mball,吃水深度2-h
m=28.12;
H=20;
trueh=zeros(3000,0);
```
...
Alpha=acot((F5*cos(theta5)+Fchain*cos(thetachain)+Gball-Ffball)/(F5*sin(theta5)+Fchain*sin(thetachair)));
H1=cos(alpha1);
H2=cos(alpha2);
H3=cos(alpha3);
H4=cos(alpha4);
