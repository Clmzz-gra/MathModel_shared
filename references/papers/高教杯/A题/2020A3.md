...
某些位置上的焊接区域中心温度可以用过温度传感器测试, 焊接区域中心温度曲线也被称为炉温曲线。附件是某次实验中的炉温曲线数据, 每隔 0.5s 采集一次炉温数据。该次实验中, 各温区设定的温度参数为 $175^{\circ} \mathrm{C}$ (小温区 1\~5)、 $195^{\circ} \mathrm{C}$ (小温区 6)、 $235^{\circ} \mathrm{C}$ (小温区 7)、 $255^{\circ} \mathrm{C}$ (小温区 8\~9) 及 $25^{\circ} \mathrm{C}$ (小温区 10\~11); 传送带的速度参数为 $70 \mathrm{~cm} / \mathrm{min}$ ; 焊接区域的厚度为 $0.15 \mathrm{~mm}$ 。当焊接区域中心温度达到阀值 $30^{\circ} \mathrm{C}$ 时, 温度传感器开始工作。当电路板进入回焊炉时, 开始计时。

为控制产品质量, 实际生产时通常通过调节各温区的设定温度和传送带的锅炉速度的方法。在上述实验设定的温度基础上, 各温区的设定温度可以在±10°C范围内进行调整。调整小温区温度时, 需满足以下限制: 小温区 1\~5 中的温度保持一致, 小温区 8\~9 中的温度保持一致, 小温区 10\~11 中的温度保持 25°C。传送带的过炉速度调节范围为 65\~100 cm/min。
...
假设: 传送带过炉速度为 $78 \mathrm{~cm} / \mathrm{min}$ , 各温区温度的设定值分别为 $173^{\circ} \mathrm{C}$ (小温区 $1 \sim 5$ )、 $198^{\circ} \mathrm{C}$ (小温区 6)、 $230^{\circ} \mathrm{C}$ (小温区 7) 和 $257^{\circ} \mathrm{C}$ (小温区 $8 \sim 9$ ),
...
![](images/054f22c2ca43b2760e6ea2abf81fd0ff768bfa389cd48d00b274a9a8149a5010.jpg)  
图1 炉温曲线示意图
...
<table><tr><td>符号</td><td>说明</td><td>单位</td></tr><tr><td>1</td><td>回焊炉上的点与炉前区域左边缘的距离</td><td>cm</td></tr></table>

科研交流微信扫描二维码，关注我的公众号

<table><tr><td>u</td><td>温度</td><td>°C</td></tr><tr><td>t</td><td>时间</td><td>s</td></tr><tr><td>x</td><td>小温区间隙中的点距离上一温区右边缘的距离</td><td>cm</td></tr><tr><td>h</td><td>焊接区域中的点与焊接中心的距离</td><td>mm</td></tr><tr><td> $t_j$ </td><td>第j个时间微元, $t_j + \Delta t = t_{j+1}$ </td><td>s</td></tr><tr><td> $u_i^j$ </td><td>第i个微元在 $t_j$ 的温度</td><td>°C</td></tr><tr><td> $u^{-1}(190)$ </td><td>焊接区域中心温度为190°C时的时间t</td><td>s</td></tr></table>
...
① 对于一个物体，t 时刻 $\Delta V$ 内的热量 Q 可以用以下等式表达。
...
![](images/0acb9296c754e5a263437bfd0a7abe5f938f4cb7751ae0a1385e25fb6e06ebcb.jpg)  
科研交流微信扫描二维码，关注我的公众号  
图2 长为 L 的均匀细杆
...
$$
\lambda \frac {\partial u}{\partial n} = h _ {z} (u _ {\mathrm{空气}} - u _ {\mathrm{表面}})\tag{6}
$$
...
其中 t 为时间，x 为该点到上一小温区边缘的距离， $0 \leqslant x \leqslant 5(\text{cm})$ 。达到热稳态后，温度恒定，则：
...
$$
\begin{array}{c c c} \text {“小温区0”} & \text {间隙0} & \text {小温区1} \\ \hline u (l \leqslant a) = 2 5 & u (a \leqslant 1 \leqslant 2 5) & u (2 5 \leqslant 1 \leqslant 5 0. 5) = 1 7 5 \\ \hline \end{array}
$$
...
$$
\begin{array}{r l} & u (3 4 4. 5 \leq x \leq 4 1 0. 5) = 2 5 \\ & u (x \geq 4 1 0. 5) = 2 5 。 \end{array}
$$

同理, 可将炉外的空间视为另外一个温度为 $25^{\circ} \mathrm{C}$ 的“小温区”, 根据 Step 1 中的求解可知炉后区域的温度分布为线性分布, 而:
...
<table><tr><td>x</td><td>温区</td><td>温度</td></tr><tr><td rowspan="2">[0,25]</td><td rowspan="2">炉前区域</td><td> $25(0 \leqslant x \leqslant a)$ </td></tr><tr><td> $25 + \frac{25}{3}(x - 7)(a \leqslant x \leqslant 25)$ </td></tr><tr><td>[25,197.5]</td><td>小温区1-5(包含间隙1-4)</td><td>175</td></tr><tr><td>[197.5,202.5]</td><td>间隙5</td><td>175+4x</td></tr><tr><td>[202.5,233]</td><td>小温区6</td><td>195</td></tr><tr><td>[233,238]</td><td>间隙6</td><td>195+4x</td></tr><tr><td>[238,268.5]</td><td>小温区7</td><td>235</td></tr><tr><td>[268.5,273.5]</td><td>间隙7</td><td>235+4x</td></tr><tr><td>[273.5,339.5]</td><td>小温区8-9(包含间隙8)</td><td>255</td></tr><tr><td>[339.5,344.5]</td><td>间隙9</td><td>255-46x</td></tr><tr><td>[344.5,410.5]</td><td>小温区10-11(包含间隙10)</td><td>25</td></tr><tr><td>[410.5,435.5]</td><td>炉后区域</td><td>25</td></tr></table>

科研交流微信扫描二维码，关注我的公众号

回焊炉内部温度曲线图(摄氏度)  
![](images/97367b1e5e5db47b5a2411325be054876cfb4fecd373e93865639833b1419b3f.jpg)  
图5回焊炉内部温度曲线图
...
![](images/4ffe17f4979c978099c9df043756615aa20e3a5a95f8a23aa6bb3fc4d24e1776.jpg)
...
生产车间的室温为 $25^{\circ} \mathrm{C}$ , 则初始条件为:
...
$$
\frac {\partial u (h , t)}{\partial h} | _ {h = 0} = 0\tag{13}
$$
...
$$
\left\{ \begin{array}{c} \frac {\partial u (h , t)}{\partial t} = A \frac {\partial^ {2} u (h , t)}{\partial h ^ {2}} \\ u (h, 0) = 2 5 (0 \leq h \leq H) \\ \frac {\partial u (h , t)}{\partial h} | _ {h = 0} = 0 \\ \lambda \frac {\partial u}{\partial h} = h _ {z} \left(u _ {0} - u _ {H}\right) \end{array} \right.\tag{16}
$$

## 5.1.5 参数估计

在该一维传热模型中， $a, A, B_{1}, B_{2}$ 为未知量，需要通过最小二乘法建立参数估计模型：

$$
(a, A, B _ {1}, B _ {2}) = \underset {a, A, B _ {1}, B _ {2}} {\arg \min} \sum_ {j = 1} ^ {m} (u (t _ {j}) - u ^ {*} (t _ {j}) ^ {2})
$$
...
参数估计： $(a,A,B_{1},B_{2}) = \underset {a,A,B_{1},B_{2}}{\arg min}\sum_{j = 1}^{m}\left(u(t_{j}) - u^{*}(t_{j})^{2}\right)$
...
$$
\frac {u _ {2} ^ {j} - u _ {1} ^ {j + 1}}{\Delta x} = B _ {1} \left(u _ {1} ^ {j} - u _ {o}\right) (0 \leq t \leq 2 9 5. 2 9)\tag{18}
$$
...
$$
\frac {u _ {2} ^ {j} - u _ {1} ^ {j + 1}}{\Delta x} = B _ {1} \left(u _ {1} ^ {j} - u _ {o}\right) (0 \leq t \leq 2 9 5. 2 9)
$$

$$
\frac {u _ {2} ^ {j} - u _ {1} ^ {\overline {{j + 1}}}}{\Delta x} = B _ {2} \left(u _ {1} ^ {j} - u _ {o}\right) (2 9 5. 2 9 \leq t \leq 3 7 3. 2 9)
$$

$$
\frac {\partial u (h , t)}{\partial h} \mid_ {h = 0} = 0
$$
...
转化系数 $h_{z} \in [5,25]$ $A \in [0.09224, 0.06417]$ $B \in [10, 100]$
...
![](images/832bf4738bd517210c4ef8b0c7ab0d731f29434db96e1b586338068074b506ef.jpg)  
图7 模型计算与实际温度分布图像比较

表3 拟合情况

<table><tr><td>A</td><td> $B_1$ </td><td> $B_2$ </td><td>a</td><td> $R^2$ </td></tr><tr><td>0.0003</td><td>70</td><td>21</td><td>7</td><td>0.9813</td></tr></table>
...
将问题一题干所给的各个温区温度分布带入上述模型，得到结果如下：炉温曲线图：

![](images/d0ea6778d4ca4da52c6652d7ec396e72683249388e7b74ec78be95f56cc88cc0.jpg)  
图8 炉温曲线图
...
![](images/c4d5296d9d4f2d3a605beb6ffacd95b1f7219e20f6d6d62eb68234dc7c706b36.jpg)

![](images/2c956a73564c4297a4dfe03632ba80041e958a1669489c6b1617f96ee78f5e17.jpg)

f-a曲线  
![](images/66b53c404e31fad46cc80571c12a5a12ee41edfad0681f8c9a6724a0c75eeed5.jpg)

f-1/w曲线  
![](images/618d92f6ffdd14347bad0b0e7fcb9e9b87d79bbc8cf2e6ceb931141a3c7b0116.jpg)  
图9 对四个变量进行灵敏度分析的结果图
...
$$
6 5 \leq v \leq 1 0 0\tag{23}
$$

$$
\left| \frac {d u}{d t} \right| \leq 3\tag{24}
$$

$$
\left[ \begin{array}{c} \frac {d u}{d t} > 0 \\ 6 0 \leq u ^ {- 1} (1 9 0) - u ^ {- 1} (1 5 0) \leq 1 2 0 \end{array} \right.\tag{25}
$$

$$
4 0 \leq m a x \{t | u \geq 2 1 7 \} - m i n \{t | u \geq 2 1 7 \} \leq 9 0\tag{26}
$$

$$
2 4 0 \leq \max _ {t} u (t) \leq 2 5 0\tag{27}
$$
...
$$
2 4 0 \leq \max _ {t} u (t) \leq 2 5 0
$$
...
$$
\lambda \frac {\partial u}{\partial h} = h _ {z} (u _ {o} - u _ {H})\tag{28}
$$
...
$$
\begin{array}{r l} 6 0 \leq & \min \{t | 1 9 0 \leq u (t _ {j}) \leq m a x u, j = 1, 2, 3 \dots \} - \min \{t | u (t _ {j}) \geq 2 1 7 \} \\ & \leq 1 2 0, j = 1, 2, 3 \dots \} \end{array}
$$

$$
\begin{array}{r l} 4 0 \leq & m a x \{t | u (t _ {j}) \geq 2 1 7, j = 1, 2, 3 \dots \} - m i n \{t | u (t _ {j}) \geq 2 1 7, j = 1, 2, 3 \dots \} \\ & \leq 9 0 \end{array}
$$

$$
2 4 0 \leq \max _ {t _ {j}} u (t) \leq 2 5 0 j = 1, 2, 3 \dots\tag{29}
$$
...
![](images/0a6e77edbdc70f9610c478f01239345c3f5ef0b716a8a0c02b5b1d181c33853f.jpg)  
图10 $v = 76 \mathrm{~cm} / \mathrm{m}$ 时炉温曲线图
...
$$
2 4 0 \leq \max _ {t} u (t) \leq 2 5 0\tag{30}
$$
...
$$
t ^ {\prime} = \min \{t | u \geq 2 1 7 \}
$$

$$
t ^ {\prime \prime} = \underset {t} {\operatorname{argmax}} u (t)
$$
...
$$
2 4 0 \leq \max _ {t} u (t) \leq 2 5 0\tag{31}
$$
...
$$
\begin{array}{c} 6 0 \leq \min \bigl \{t \big | 1 9 0 \leq u (t _ {j}) \leq m a x u, j = 1, 2, 3 \dots \bigr \} - \min \bigl \{t \big | u (t _ {j}) \geq 2 1 7 \bigr \} \\ \leq 1 2 0, j = 1, 2, 3 \dots \bigr \} \end{array}
$$

$$
\begin{array}{r l} 4 0 \leq & \max \{t | u (t _ {j}) \geq 2 1 7, j = 1, 2, 3 \dots \} - \min \{t | u (t _ {j}) \geq 2 1 7, j \\ & = 1, 2, 3 \dots \} \leq 9 0 \end{array}
$$

$$
2 4 0 \leq \max _ {t _ {j}} u (t) \leq 2 5 0 j = 1, 2, 3 \dots\tag{32}
$$

## 5.3.3 优化方法：爬山算法与 A\*算法

由于优化问题的搜索参数由有4个温度值以及一个速度值，而每个温度值可以正负变化10度，速度值有36个，故搜索空间中大致包含 $21^{4} * 36 \approx 7000000$ 个状态值。由于巨大的搜索空间导致遍历在短时间内是不可能的，因此我们采用人工智能搜索方法，结合局部搜索算法——爬山算法与启发式搜索算法—— $A^{*}$ 算法。接下来先介绍俩个算法的内容：
...
Step 4: 若 node 的目标函数值 $<$ optimal 的目标函数值, 则 optimal $=$ node, 跳至 Step 2; 若 node 的目标函数值 $\geq$ optimal 的目标函数值, 则跳至 Step由于上述A\*算法可以遍历整个状态空间，因此我们对于该最优化问题的策略是：Step 1：计算机多次产生随机状态并运行爬山算法，记录其中的最优状态。
...
<table><tr><td>u(小温区 1-5)</td><td>u(小温区 6)</td><td>u(小温区 7)</td><td>u(小温区 8-9)</td><td>u(小温区 10-11)</td><td>v</td><td>面积</td></tr><tr><td>185</td><td>203</td><td>238</td><td>265</td><td>25</td><td>97</td><td>403.069</td></tr></table>

## 问题4

问题四在问题三的基础上，新增加了一个优化目标，要使以峰值温度为中心线的两侧超过 $217^{\circ}\mathrm{C}$ 的炉温曲线应尽量对称。则首先需要对优化目标进行线性加权，将两个优化目标简化为与问题三类似的单目标优化求解。最后建立优化模型，使用爬山与 $\mathsf{A}^*$ 方法求解。
...
此外，简化 $max z_{1}z_{2}$ 的取值过程，由程序随机抽取有限个样本，使用样本中最大的 $z_{1}z_{2}$ 代替 $maxz_{1}maxz_{2}$
...
$$
\begin{array}{r l} & L = \min \{t _ {j} | u (t _ {j}) \geq 2 1 7 \} \\ & R = \max \{t _ {j} | u (t _ {j}) \geq 2 1 7 \} \\ & t ^ {\prime} = m i n \{t | u \geq 2 1 7 \} \\ & t ^ {\prime \prime} = \underset {t} {\operatorname{argmax}} u (t) \end{array}
$$
...
$$
\left\{ \begin{array}{c} t ^ {\prime} = \min \{t | u \geq 2 1 7 \} \\ t ^ {\prime \prime} = \underset {t} {\operatorname{argmax}} u (t) \\ \left| \frac {u \left(t _ {j}\right) - u \left(t _ {j} - \Delta t\right)}{\Delta t} \right| \leq 3 \\ 6 0 \\ \leq \min \{t | 1 9 0 \leq u \left(t _ {j}\right) \leq \max u, j = 1, 2, 3 \dots \} - \min \{t | u \left(t _ {j}\right) \geq 2 1 7 \} \\ \leq 1 2 0, j = 1, 2, 3 \dots \} \\ 4 0 \leq \max \{t | u \left(t _ {j}\right) \geq 2 1 7 \} - \min \{t | u \left(t _ {j}\right) \geq 2 1 7 \} \leq 9 0 j \\ = 1, 2, 3 \dots \\ 2 4 0 \leq \underset {t _ {j}} {\max} u (t) \leq 2 5 0 j = 1, 2, 3 \dots . \end{array} \right.
$$
...
<table><tr><td>参数组合</td><td>u(小温区1-5)</td><td>u(小温区6)</td><td>u(小温区7)</td><td>u(小温区8-9)</td><td>u(小温区10-11)</td><td>v</td><td>Z</td></tr><tr><td>1</td><td>183</td><td>197</td><td>240</td><td>264</td><td>25</td><td>94</td><td>0.99386</td></tr><tr><td>2</td><td>184</td><td>193</td><td>239</td><td>264</td><td>25</td><td>93</td><td>1.00468</td></tr><tr><td>3</td><td>179</td><td>191</td><td>242</td><td>264</td><td>25</td><td>92</td><td>1.01619</td></tr><tr><td>4</td><td>179</td><td>201</td><td>236</td><td>264</td><td>25</td><td>92</td><td>1.01659</td></tr><tr><td>5</td><td>184</td><td>195</td><td>230</td><td>264</td><td>25</td><td>90</td><td>1.03804</td></tr></table>
...
```txt
{
    ...
    printf("Case  1:i:%d   j:%d dx:%LF dt:%Lf -(dx*dx/dt/2/A*(THJ[i][j+1]-THJ[i][j-1]):%Lf THJ[i][j+1]:%Lf THJ[i-1][j+1]:%Lf THJ[i+1][j+1]:%Lf dx,dt, -(dx*dx/dt/2/A*(THJ[i][j+1]-THJ[i][j-1]))/2,THJ[i][j+1],THJ[i-1][j+1],THJ[i+1][j+1]),exit(0);
...
THJ[i+1][j+1]:%Lf\n",i,j,
    dx,dt,
    -(dx*dx/dt/2/A*(THJ[i][j+1]-THJ[i][j-1]))/2,THJ[i][j+1],THJ[i-1][j+1],THJ[i+1][j+1]),exit(0);
    */
    MXI=max(MXI,i+2);
...
for(j=0,t=0;t*v<=500;t+=dt,j++)
{
    ...
    /* if(j)
    THJ[i+1][j+1]=dx*dx/2/dt/A*(THJ[i][j+1]-THJ[i][j-1])+2*THJ[i][j+1]-THJ[i-1][j+1];
    else THJ[i+1][j+1]=dx*dx/dt/A*(THJ[i][j+1]-THJ[i][j])+2*THJ[i][j+1]
    THJ[i-1][j+1];
...
THJ[i+1][j+1]:%Lf\n",i,j,
    ...
    printf("Case 2:i:%d j:%d dx:%LF dt:%Lf -(dx*dx/dt/2/A*(THJ[i][j+1]-THJ[i][j-1]):%Lf THJ[i][j+1]:%Lf THJ[i-1][j+1]:%Lf
THJ[i+1][j+1]:%Lf\n",i,j,
    dx,dt, -(dx*dx/dt/2/A*(THJ[i][j+1]-THJ[i][j-1]))/2,THU[i][j+1],THU[i-1][j+1],THU[i+1][j+1]),exit(0);
    */
    MXI=max(MXI,i+2);
    }
    if(abs(STD[ni][0]-tim[j])<1e-6)
...
struct Pa
{
    ...
    Pa() {
    Pa(Id t1,Id t2,Id t3,Id t4,Id vv,Id MM):T1(t1),T2(t2),T3(t3),T4(t4),v(vv),M(MM) {
    void
...
ld ttp=40;
ld Bt;
ld S[21][21][21][21][21][41];
int Out[21][21][21][21][21][41];
...
for(j=0,t=0;t*v<=500;t+=dt,j++)
{
    ...
    {
    if(j)
    THJ[i+1][j+1]=(-(dx*dx/dt/2/A*(THJ[i][j+1]-THJ[i][j-))+THJ[i][j]+THJ[i+2][j])/2;
    else THJ[i+1][j+1]=25;
    MXI=max(MXI,i+2);
    }
...
```c
if(x>=339.5&&x<344.5)return T4+(T5-T4)/5.*(x-339
return 25;
}
...
struct Pa
{
    ...
    inline bool friend operator < (Pa a,Pa b){return a.M>b.M;}
    Pa(){};
    Pa(Id t1,Id t2,Id t3,Id t4,Id vv,Id MM):T1(t1),T2(t2),T3(t3),T4(t4),v(vv),M(MM){} void
print(){printf("%.0Lf\t%.0Lf\t%.0Lf\t%.0Lf\t%.0Lf\t%.3Lf\n",T1,T2,T3,T4,v*60,M);}};
priority_queue<Pa>Q;
Id TH[900000];
Id THJ[220][500000];//i x j 时间
...
MINS=Area;
//printf("T1:%Lf\tT2:%Lf\tT3:%Lf\tT4:%Lf\tv:%Area:%Lf\tYES\n",T1,T2,T3,T4,v*60,Area);
goto ed;
pl:Area=1e100;
//printf("T1:%Lf\tT2:%Lf\tT3:%Lf\tT4:%Lf\tv:%Area:%Lf\tYES\n",T1,T2,T3,T4,v*60,Area);
ed.;
...
$$
2 6 4, \mathrm{v} = 9 4. / 6 0, \mathrm{M} = \text { solve(); }
$$

$$
2 6 4, v = 9 3. / 6 0, M = \text { solve(); }
$$

$$
2 6 4, \mathrm{v} = 9 2. / 6 0, \mathrm{M} = \text { solve(); }
$$

$$
\begin{array}{l} \mathrm{T1=184,T2=195,T3=230,T4=264,v=90./60,M=solve();} \\ \mathrm{Q.push(Pa(T1,T2,T3,T4,v,M));} \end{array}
$$

$$
\begin{array}{l} \text {T1 = 180,T2 = \quad 193,T3 = \quad 239,T4 = \quad 263,v = \quad 90. / 60,M = solve();} \\ \text {Q.push(Pa(T1,T2,T3,T4,v,M));} \end{array}
$$
...
struct Pa
{
    ...
    Pa()};
    Pa(Id t1,ld t2,ld t3,ld t4,ld vv,pr MM):T1(t1),T2(t2),T3(t3),T4(t4),v(vv),M(MM){} void
print(){printf("%.0Lf\t%.0Lf\t%.0Lf\t%.0Lf\t%.0Lf\t%.3Lf\n",T1,T2,T3,T4,v*60,M .x/BIG1+M.y/BIG2);}}; priority_queue<Pa>Q;
Id TH[900000];
Id THJ[220][500000];//i x j 时间
Id tim[900000];
...
while(!Q.empty())
{
    ...
    t4=int(T4+1e-1)-245;
    vv=int(v*60+1e-1)-65;
//printf("%.OLft%.OLft%.OLft%.OLft%.OLft%.3Lfn",T1,T2,T3,T4,v
```
...
printf("%.0Lf\t%.0Lf\t%.0Lf\t%.0Lf\t%.0Lf\t%Lf\t%Lft%.6Lf\n",Best.T1,B.T2,Best.T3,Best.T4,Best.v*60,Best.M.x,Best.M.y,Best.M.x/BIG1+Best.M.yG2);
