...
![](images/f7eb383d2f0302331e7de72427fc1f2fae7fd2ffefb4fb8e3d68e8614ce2ed4c.jpg)  
图 1：定日镜场的大地坐标系
...
![](images/9dfbd731c184dd5767df21db88dcc0059af2874e1c470697ac21b35840cf5735.jpg)  
图 2：太阳方位角和高度角图示
...
![](images/0e4c801ae91dce1be7902f278440d9958b1e3d2cbee4263c79eb63ee6ebd88db.jpg)  
...
$$
\alpha = \left\{ \begin{array}{l} \arccos \left(\frac {\vec {n} _ {0} \cdot \vec {S}}{| \vec {n} _ {0} | \cdot | \vec {S} |}\right), \vec {n} _ {0} (2) \geq 0 \\ - \arccos \left(\frac {\vec {n} _ {0} \cdot \vec {S}}{| \vec {n} _ {0} | \cdot | \vec {S} |}\right), \vec {n} _ {0} (2) <   0 \end{array} \right.\tag{3}
$$
...
![](images/7930350d8b40f8e49a9c7a4f19f8811d12c23981f20fd28baf4ba7388a83424b.jpg)  
图 4：定日镜面的坐标系

## 4.1.4 光锥坐标系的建立

太阳光并非平行光线，而是具有一定锥形角的一束锥形光线，因此太阳入射光线经定日镜任意一点的反射光线也是一束锥形光线。在考虑阴影遮挡和集热器吸收能量时，需要考虑锥形光束的吸收和遮挡。因此，我们需要建立起以主入射光线和主反射光线为锥体中心线的光锥坐标系。大地坐标系下的反射光锥束的中心主光线$\vec { L } _ { z } = \left( m , n , p \right)$ ，以主光线为 z 轴，则 z 轴的方向向量为 $\vec { s } = \left( \begin{array} { r l } \end{array} \right)$ ，则锥体光线束的俯仰角 $\beta _ { z }$ 为：

$$
\beta_ {z} = \frac {\pi}{2} - \arccos \frac {\vec {L} _ {z} \cdot \vec {s}}{\left| \vec {L} _ {z} \right| \cdot | \vec {s} |}
$$
...
![](images/da13aa750b5ddb77f45ad71a81ef1d38db0739d6dc7e0d852938eb88facff243.jpg)  
图 5：光椎束的坐标系（X-Y-Z）
...
![](images/7c10057766e2f44df179713075dbf79d6baadb9fa6b9e2e760d29ddd5b12b7b8.jpg)  
图 6：塔损失模型
...
$$
\left\{ \begin{array}{l l} \Delta = 4 \left(m ^ {\prime} x _ {0} + n ^ {\prime} y _ {0}\right) ^ {2} - 4 \left(m ^ {\prime 2} + n ^ {\prime 2}\right) \left(x _ {0} ^ {2} + y _ {0} ^ {2} - R ^ {2}\right) <   0, & \text {无遮挡} \\ \Delta = 4 \left(m ^ {\prime} x _ {0} + n ^ {\prime} y _ {0}\right) ^ {2} - 4 \left(m ^ {\prime 2} + n ^ {\prime 2}\right) \left(x _ {0} ^ {2} + y _ {0} ^ {2} - R ^ {2}\right) \geq 0, & \text {有交点} \end{array} \right.\tag{9}
$$
...
![](images/2c726d6bd2fad8b9b960c240183478706cb1926db68edea079c8b0018124b2d4.jpg)  
...
$$
b _ {2} ^ {i} = \left\{ \begin{array}{l l} 0, & \text { else,   未挡住 } \\ 1, & \text { if   } - 3 \leq x _ {i}, y _ {i} \leq 3 \text {   and   } z _ {1} ^ {\prime} <   Z, \end{array} \right. \text { 挡住 }\tag{14}
$$
...
$$
b _ {3} ^ {i} = \left\{ \begin{array}{l l} 0, & e l s e, \text {未挡住} \\ 1, & i f - 3 \leq x _ {r}, y _ {r} \leq 3 a n d z _ {1} ^ {\prime} <   Z, \text {挡住} \end{array} \right.\tag{17}
$$

最后，将综合以上三部分的阴影遮挡损失，可得到阴影遮挡效率，N为总光线数量。

$$
\begin{array}{l} \eta_ {s b} = 1 - \sum_ {i = 1} ^ {N} \left(b _ {1} ^ {i} + b _ {2} ^ {i} + b _ {3} ^ {i}\right) / N \\ \left\{ \begin{array}{l} i f b _ {1} ^ {i} = 1 \Rightarrow b _ {2} ^ {i} = 0, b _ {3} ^ {i} = 0 \\ i f b _ {1} ^ {i} = 0 \Rightarrow b _ {2} ^ {i} = 0, 1 \\ i f b _ {2} ^ {i} = 0 \Rightarrow b _ {3} ^ {i} = 0, 1 \\ i f b _ {2} ^ {i} = 1 \Rightarrow b _ {3} ^ {i} = 1 \end{array} \right. \end{array}\tag{18}
$$
...
$$
\left\{ \begin{array}{l l} \min \left\{\left(H - z _ {0}\right) t _ {1} + z _ {i}, \left(H - z _ {0}\right) t _ {2} + z _ {i} \right\} \in [ 7 6, 8 4 ], & \text {成功接收} \\ \min \left\{\left(H - z _ {0}\right) t _ {1} + z _ {i}, \left(H - z _ {0}\right) t _ {2} + z _ {i} \right\} \notin [ 7 6, 8 4 ], & \text {无法接收} \end{array} \right.
$$

引入 0，1 变量r ，表示第j根成功反射的光线是否接收。且每块定日镜均需要进行反 $r _ { j }$ 射光线或光锥束接收计算：
...
$$
\eta_ {t r u n c} = \frac {\sum_ {j = 1} ^ {N ^ {\prime}} r _ {j}}{N ^ {\prime} - \sum_ {i = 1} ^ {N ^ {\prime}} \left(b _ {1} ^ {i} + b _ {2} ^ {i} + b _ {3} ^ {i}\right)}\tag{22}
$$
...
![](images/8bb5ae8e93403517bc8af085f4380b7d1184ee9a7303e710d187a215d2c1b53a.jpg)  
（a）光线沿镜面法线方向入射

![](images/06bf0b7c7689778d6d76601bab850c9c1f3bd89a93ec935f3e6614ab0ee65da2.jpg)  
（b）光线沿非镜面法线方向入射  
图 8：余弦损失的示意图
...
$$
E _ {f i e l d} ^ {j} = D N I \cdot \sum_ {i = 1} ^ {n} A _ {i} n _ {i} ^ {j}
$$

其中， $A _ { i }$ 为第 i 面定日镜的采光面积， $\eta _ { i } ^ { j }$ 表示第j个时刻光学效率，法向直接辐射辐照度DNI的计算公式如下，其中 $G _ { 0 } = 1 . 3 6 6 k W / m ^ { 2 }$ $H = 3 0 0 0 m$

$$
\begin{array}{l} D N I = G _ {0} \left[ a + b \exp \left(- \frac {c}{\sin \alpha_ {s}}\right) \right] \\ a = 0. 4 2 3 7 - 0. 0 0 8 2 1 (6 - H) ^ {2} \\ b = 0. 5 0 5 5 + 0. 0 0 5 9 5 (6. 5 - H) ^ {2} \\ c = 0. 2 7 1 1 + 0. 0 1 8 5 8 (2. 5 - H) ^ {2} \end{array}
$$
...
$$
\overline {{P}} = \sum_ {i = 1} ^ {1 2} \overline {{E}} _ {f i e l d} ^ {i} / 1 2\tag{26}
$$
...
![](images/e67835e769656450415332c7564957af3396b3e6160ddb207819ad26c5924065.jpg)  
...
$$
\left\{ \begin{array}{l} \frac {x - x _ {0}}{m ^ {\prime}} = \frac {y - y _ {0}}{n ^ {\prime}} = \frac {z - z _ {0}}{p ^ {\prime}} = t \\ (x - X _ {0}) ^ {2} + (y - Y _ {0}) ^ {2} = R ^ {2} \end{array} \Rightarrow \left\{ \begin{array}{l} x = x _ {0} + m ^ {\prime} t \\ y = y _ {0} + n ^ {\prime} t \\ z = z _ {0} + p ^ {\prime} t \end{array} \right. \right.\tag{29}
$$
...
![](images/06b6518e3967d79607bdfbb31e2fbe6b08f2e1abdf467bc79c8c2b5a8d9b657d.jpg)

![](images/90ee3db950ff6216257cd6ec6f5dc2f049d8a041fa4177471d3c6584707db7d4.jpg)  
图 10：蜂窝排列法确定定日镜尺寸、数目和位置（左）和计算后的图（右）

$$
\begin{array}{l} \text {line1:} \left\{ \begin{array}{l} x _ {1 1} = - R \\ y _ {1 1} = R \end{array} , \left\{ \begin{array}{l} x _ {1 2} = x _ {1 1} + w + 5 \\ y _ {1 2} = y _ {1 1} \end{array} , \dots , \left\{ \begin{array}{l} x _ {1 n} = x _ {1 1} + (n - 1) (w + 5) \\ y _ {1 n} = y _ {1 1} \end{array} \right. \right. \right. \\ \text {line2:} \left\{ \begin{array}{l} x _ {2 1} = - R + \frac {w + 5}{2} \\ y _ {2 1} = R - \frac {w + 5}{2} \sqrt {3}, \left\{ \begin{array}{l} x _ {2 2} = - R + \frac {w + 5}{2} + w + 5 \\ y _ {2 2} = R - y _ {2 1} \end{array} , \dots , \left\{ \begin{array}{l} x _ {2 n} = - R + \frac {w + 5}{2} + (n - 1) (w + 5) \\ y _ {2 n} = R - y _ {2 1} \end{array} \right. \right. \end{array} \right. \end{array}
$$
...
$$
\begin{array}{l} \max \left\{\overline {{P}} _ {s} \right\} = \max \left\{\left[ \sum_ {i = 1} ^ {1 2} \overline {{E}} _ {\text {field}} ^ {i} / (1 2 * \tilde {S}) \right] \right\} \\ \left\{ \begin{array}{l} \left(x _ {i} - X _ {0}\right) ^ {2} + \left(y _ {i} - Y _ {0}\right) ^ {2} \geq 1 0 0 ^ {2} \\ w _ {i} \geq v _ {i}, 2 \leq w _ {i} \leq 8, 2 \leq v _ {i} \leq 8 \\ 2 \leq \tilde {h} _ {i} \leq 6, v _ {i} / 2 <   \tilde {h} _ {i} \\ \sqrt {\left(x _ {i} - x _ {j}\right) ^ {2} + \left(y _ {i} - y _ {j}\right) ^ {2} + \left(z _ {i} - z _ {j}\right) ^ {2}} > w _ {i} + 5 \\ x _ {i} ^ {2} + y _ {i} ^ {2} \leq 3 5 0 ^ {2} \\ \overline {{P}} _ {s} \cdot \tilde {S} \geq 6 0 \end{array} \right. \end{array}\tag{33}
$$
...
![](images/150c5bd42812078c3b662231918daf593d897d77e86bab56088c9e38e137ed78.jpg)  
图 11：斜坡式排列
...
二十五##### 二、判断入射光线是否被其他光镜遮挡
二十五##### indices_in_circle = np.where(Dis[:,i] == 1)[0] # 取周围半径
